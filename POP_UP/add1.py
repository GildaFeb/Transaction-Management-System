...
# Form implementation generated from reading ui file '3add_to_list_confirm.ui'
#
...
class Add_Categ(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Add to list"))
        self.label_3.setText(_translate("Dialog", "<html><head/><body><p>Do you want to add the item to the list?<br/>This can\'t be undone.</p></body></html>"))
