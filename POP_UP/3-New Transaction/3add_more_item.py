...
# Form implementation generated from reading ui file '3add_more_item.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Add more item"))
        self.label_3.setText(_translate("Dialog", "<html><head/><body><p>Do you want to add more item?<br/>This can\'t be undone.</p></body></html>"))
