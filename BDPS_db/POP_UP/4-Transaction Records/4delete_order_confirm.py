...
# Form implementation generated from reading ui file '4delete_order_confirm.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Delete order"))
        self.label_3.setText(_translate("Dialog", "<html><head/><body><p>Are you sure to delete the item/s?<br/>This can\'t be undone.</p></body></html>"))
